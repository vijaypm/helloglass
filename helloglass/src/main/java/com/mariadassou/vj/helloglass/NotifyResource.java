...
public class NotifyResource {
	  private static final Logger LOG = Logger.getLogger(NotifyResource.class.getSimpleName());
	  
		@Path("glassnotify")
		@POST
	    @Consumes(MediaType.APPLICATION_JSON)
		public Response postGlassNotify(Notification notification) throws IOException{
